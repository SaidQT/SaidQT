...
<ul>
  <li>
    <strong><a href="[QUIZZIZ](https://github.com/SaidQT/mern-proj)" target="_blank">Quizizz Platform</a></strong> - A MERN-based quiz platform that allows users to create, take, and manage quizzes.
  </li>
  <li>
    <strong><a href="[SOAR](https://github.com/SaidQT/SOAR)" target="_blank">SOAR</a></strong> - A Spring Boot-based web application for browsing and adopting pets, built with Java.
  </li>
  <li>
    <strong><a href="[YELP](https://github.com/SaidQT/Yelp)" target="_blank">YELP</a></strong> - A Django platform for reviewing Palestinian businesses, featuring user authentication and dynamic content.
  </li>
</ul>
